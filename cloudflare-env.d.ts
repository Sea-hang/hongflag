/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 8634c64577558f26dbf7222b9a9c7b40)
// Runtime types generated with workerd@1.20260706.1 2026-07-08 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ACTIVITIES_STORE: KVNamespace;
	SETTINGS_STORE: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	WORKER_SELF_REFERENCE: Fetcher /* school-website */;
}
