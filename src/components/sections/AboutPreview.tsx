...
export function AboutPreview() {
  ...
  return (
    <section ref={ref} className="section-panel-alt py-24 md:py-32 max-md:py-16">
      <div className="max-w-5xl mx-auto px-5">
        ...
        >
          ...
          <div className="content-card p-6 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-14 items-center">
